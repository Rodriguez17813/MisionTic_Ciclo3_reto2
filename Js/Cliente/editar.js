...
function editarRegistro(llaveRegistro) {
    ...
    $.ajax({
        ...
        url: "https://g2678b86f1821b3-db202110010700.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client/" + llaveRegistro,
...
function actualizar() {
    ...
    if (validarEditar()) {
        $.ajax({
            // la URL para la petición (url: "url al recurso o endpoint")
            url: "https://g2678b86f1821b3-db202110010700.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client",
